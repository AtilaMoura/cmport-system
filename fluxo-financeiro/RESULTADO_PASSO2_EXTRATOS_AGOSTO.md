...
| 2 | 31/08 | R$ 590,46 | dar baixa | Cond. **742** (Assoc. Moradores Conj Res Fortezza Di Ferrara). Extrato: 31/08 +590,46 `Pix recebido Cp :60701190-CONJUNTO RESIDENCIAL FORTEZZA`. Manutenção mensal (série de julho = NF 7842, nota R$ 700,01 / boleto líquido R$ 590,46). **NF 7895** (id 1413, AUTORIZADA, `corpo_nota_id`=262) é a de agosto — `boleto id=1152` R$ 590,46 EMABERTO, venc 20/08, banco NULL. **NF 7883** (id 1387) foi **CANCELADA** e deixou `boleto id=1465` EMABERTO — é a "pendência solta" já mapeada (ver [[project_bug_delete_corpo_nota_orfao_20260902]]), não é a mensalidade. | `baixa` do `boleto 1152` (data 31/08, banco 2) + limpar boleto 1465. NÃO está na planilha mestre. |
